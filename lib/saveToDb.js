...
// const dbName = 'brainvita_2';
const dbName = 'brainvita_3';
// const dbName = 'brainvita_4';
...
module.exports.getProgress = async function (query, projection) {
    let cl = await getClient();
    let coll = cl.db(dbName).collection('progress');
    return coll.find(query, { projection }).sort({ _id: 1 }).toArray();
};
