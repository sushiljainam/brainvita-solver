...
const { refillMatrix, runSpecificPath, printBoard, getAllPaths } = require("./common");
const { runSavedSolution } = require("./printSavedSolution");
const { attemptAllSolutions } = require("./runAllSolutions");
const { saveToDb, closeDb, getSaved } = require("./saveToDb");

const boardSize = 7;

module.exports.attemptAllSolutions = async function attemptAllSolutions() {
