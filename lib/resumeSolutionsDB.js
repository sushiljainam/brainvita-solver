...
const { refillMatrix, printBoard, findNextPossibleMoves, applyMove, boardToString } = require("./common");
const { findUniqueMatrices } = require("./findSymmetry");
const { getProgress, closeDb, addToStepBoards, addToProgress } = require("./saveToDb");
